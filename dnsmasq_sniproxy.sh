...
install_sniproxy(){
    ...
    if check_sys packageManager yum; then
        ...
        download /etc/default/sniproxy https://raw.githubusercontent.com/jwstaceyOvO/dnsmasq_sniproxy_install/master/sniproxy.default
    fi
    download /etc/sniproxy.conf https://raw.githubusercontent.com/jwstaceyOvO/dnsmasq_sniproxy_install/master/sniproxy.conf
...
Install() {
    ...
    download /etc/dnsmasq.d/custom_netflix.conf https://raw.githubusercontent.com/jwstaceyOVO/dnsmasq_sniproxy_install/master/dnsmasq.conf
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/jwstaceyOVO/dnsmasq_sniproxy_install/master/proxy-domains.txt
    PublicIP=$(get_ip)
